...
def main():
    train_df, val_df = split('../work_dirs/zsbank/data/feature/train_feature.csv')
    train_df.to_csv('../work_dirs/zsbank/data/feature/split_train_feature.csv', index=False)
    val_df.to_csv('../work_dirs/zsbank/data/feature/split_val_feature.csv', index=False)
